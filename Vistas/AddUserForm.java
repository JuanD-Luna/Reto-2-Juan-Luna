...
public class AddUserForm extends javax.swing.JDialog {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtDocumentoNueUsu)
                    .addComponent(txtNombreNueUsu)
                    .addComponent(txtApellidoNueUsu)
                    .addComponent(txtCorreoNueUsu)
                    .addComponent(cbTipDocuNueUsu, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnGurdarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGurdarActionPerformed
        ...
        String docuementType = (String) cbTipDocuNueUsu.getSelectedItem();
        String document = txtDocumentoNueUsu.getText();
        String email = txtCorreoNueUsu.getText();
        System.out.println(name + "" + document + "" + email);
        
        if (name.isEmpty() || lastName.isEmpty() || document.isEmpty() || email.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Faltan campos por llenar", "Nuevo empleado", JOptionPane.WARNING_MESSAGE);
        } else {
            String queryCrearEmpleado = "INSERT INTO `empleados`(`nombreEmp`, `apellido`, `tipoDocumento`, `documento`, `correo`) VALUES ('"+ name + "','" + lastName + "','" + docuementType + "','"+ document + "','" + email + "')"; 
